...
// bca
// Income = x
// Number of Household Members (y)
// Tuition (t) = 9000 (elementary) + 12000 (middle school) + 15000 (high school)
// Expenses (z) = 0.45x (Expense percentage) + 1500y (discount per household member) + 14,000 (cost of living)
// Aid Estimate (a) = t - .5(x-z)
